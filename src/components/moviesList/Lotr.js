...
import style from "../style/lotr.module.css";
    ...
    <div>
      ...
      <div>
        <p className={`${style.kposter}`}>
          SUMMARY OF LORD OF THE RINGS <br />
          The Lord of the Rings is the saga of a group of sometimes reluctant
          heroes who set forth to save their world from consummate evil. Its
          many worlds and creatures were drawn from Tolkien's extensive
