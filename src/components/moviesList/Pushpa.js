...
import style from "../style/pushpa.module.css";
...
const Pushpa = () => {
  ...
  return (
    <div>
      <h1>Pushpa: The Rise - Part 1</h1>
      <div>
        <p className={`${style.kposter}`}>
          SUMMARY OF Pushpa: The Rise - Part 1 <br />A labourer named Pushpa
          makes enemies as he rises in the world of red sandalwood smuggling.
          However, violence erupts when the police attempt to bring down his
          illegal business.
        </p>
      </div>
      ...
      <button onClick={onClickHandler}>
        <Link to={"/Uipushpa"}> all data</Link>
      </button>
    </div>
  );
};
