...
import style from "../style/kgf.module.css";
    ...
    <div>
      ...
      <div>
        <p className={`${style.kposter}`}>
          SUMMARY OF KGF <br />
          Rocky, a young man, seeks power and wealth in order to fulfil a
          promise to his dying mother. His quest takes him to Mumbai, where he
          becomes involved with the notorious gold mafia.
        </p>
      </div>
